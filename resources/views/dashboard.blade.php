<x-app-layout>
    ...
    <div class="bg-white  overflow-hidden shadow-xl sm:rounded-lg">
        ...
        <svg class="w-8 h-8" version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512" xml:space="preserve">
          <path  class="fill-current dark:text-indigo-500 text-slate-600"
          ...
          <path  class="fill-current dark:text-indigo-500 text-slate-600"
                d="M256,346.831c-11.246,0-22.143-2.391-32.386-7.104L112.793,288.71v101.638 c0,22.314,67.426,50.621,143.207,50.621c75.782,0,143.209-28.308,143.209-50.621V288.71l-110.827,51.017 C278.145,344.44,267.25,346.831,256,346.831z"></path>
        </svg>
