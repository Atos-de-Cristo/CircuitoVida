                    ...
                    <div class="bg-white border-t-4 border-indigo-900 dark:bg-slate-800 shadow-xl rounded-md ">
                        ...
                        @can('aluno')
                            <div class="bg-gray-50 dark:bg-gray-700 px-4 rounded py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                                <span class="flex w-full rounded-md shadow-sm sm:ml-3 sm:w-auto">
                                    <button type="button" wire:click.prevent="storeQuestion()" {{ $this->questions['checkResponse']==true
                                        ? 'disabled' : '' }} class="btn-submit {{ $this->questions['checkResponse']==true ? 'opacity-50' : '' }}" >
                                        Salvar
                                    </button>
                                </span>
                            </div>
