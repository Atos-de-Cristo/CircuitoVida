<div>
    ...
    @endif
    <button wire:click.prevent="$set('isOpenCopyData', true)" class="btn-primary ">
        <x-icon-folder class="w-4 h-4" />
        <span class="ml-2">Copiar Dados</span>
    </button>
    @if ($isOpenCopyData)
        <x-dialog-modal id="myModal" wire:model.defer="isOpenCopyData" maxWidth="2xl" closeModal="$set('isOpenCopyData', false)">
            <x-slot name="title">
                Copiar Dados do curso...
            </x-slot>
                    ...
                    <div class="px-4 mb-4 pb-4 sm:p-6 sm:pb-4 text-left">
                        ...
                        <div class="max-h-80 overflow-y-auto py-4 px-4">
                            ...
                            <label class="flex items-center space-x-2">
                                <input wire:model="course" type="radio" nam="course" value="{{ $course->id }}">
            ...
            <x-slot name="footer">
                ...
                <span class="flex w-full rounded-md shadow-sm sm:mt-0 sm:w-auto">
                    <button
                        wire:click="$set('isOpenCopyData', false)"
                        type="button"
                        class="btn-default"
                    >
                        Fechar
