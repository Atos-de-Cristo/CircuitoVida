<div>
    <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg px-4 py-4">
        ...
        @endif
        <h1 class="float-left py-4 font-bold text-xl">Lista de Usuários</h1>
        <button wire:click="create()" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded my-3 float-right">Novo usuário</button>
        <table class="table-fixed w-full">
            <thead>
                <tr class="bg-gray-100">
                    <th class="text-left px-2 w-10">#</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="border px-2 py-2">{{ $data->permissions()->implode('permission', ',') }}</td>
