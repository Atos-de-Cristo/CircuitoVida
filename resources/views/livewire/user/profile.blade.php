    ...
    <x-form-section submit="store">
        ...
        <x-slot name="form">
            ...
            <div class="col-span-6 sm:col-span-4">
                ...
                <select
                    id="marital_status"
                    wire:model.defer="form.marital_status"
                    class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm"
                >
                    <option value="">Selecione</option>
            ...
            <div class="col-span-6 sm:col-span-4">
                ...
                <input
                    type="date"
                    wire:model.defer="form.date_wedding"
                    class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm"
                />
                <x-input-error for="date_wedding" class="mt-2" />
            </div>
            <div class="col-span-6 sm:col-span-4">
            ...
            <div class="col-span-6 sm:col-span-4">
                ...
                <select
                    id="uf"
                    wire:model.defer="form.uf"
                    class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm"
                >
                    <option value="">Selecione</option>
                    <option value="ce">CE</option>
                </select>
                <x-input-error for="uf" class="mt-2" />
            </div>
            <div class="col-span-6 sm:col-span-4">
            ...
            <div class="col-span-6 sm:col-span-4">
                ...
                <x-input-error for="cell_phone" class="mt-2" />
            </div>
            <div class="col-span-6 sm:col-span-4">
                <x-label for="church_relationship" value="{{ __('Relação com a igreja') }}" />
                <select
                    id="church_relationship"
                    wire:model.defer="form.church_relationship"
                    class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm"
                >
                    <option value="">Selecione</option>
                ...
                <x-input-error for="church_relationship" class="mt-2" />
            </div>
            <div class="col-span-6 sm:col-span-4">
                <x-label for="entry_date" value="{{ __('Data da entrada') }}" />
                <input
                    type="date"
                    wire:model.defer="form.entry_date"
                    class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm"
                />
            ...
            <div class="col-span-6 sm:col-span-4">
                ...
                <select
                    id="hou_meet"
                    wire:model.defer="form.hou_meet"
                    class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm"
                >
                    <option value="">Selecione</option>
                ...
                <x-input-error for="hou_meet" class="mt-2" />
            </div>
            <div class="col-span-6 sm:col-span-4">
                ...
                <x-input-error for="church_from" class="mt-2" />
            </div>
            <div class="col-span-6 sm:col-span-4">
                <x-label for="baptized" value="{{ __('Batizado') }}" />
                <select
                    id="baptized"
                    wire:model.defer="form.baptized"
                    class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm"
                >
                    <option value="">Selecione</option>
                ...
                <x-input-error for="baptized" class="mt-2" />
            </div>
            <div class="col-span-6 sm:col-span-4">
                <x-label for="accepted_jesus" value="{{ __('Aceitou Jessus') }}" />
                <select
                    id="accepted_jesus"
                    wire:model.defer="form.accepted_jesus"
                    class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm"
                >
                    <option value="">Selecione</option>
                    <option value="sim">Sim</option>
                ...
                <x-input-error for="accepted_jesus" class="mt-2" />
            </div>
            <div class="col-span-6 sm:col-span-4">
                <x-label for="date_accepted_jesus" value="{{ __('Data que aceitou Jessus') }}" />
                <input
                    type="date"
                    wire:model.defer="form.date_accepted_jesus"
                    class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm"
                />
                <x-input-error for="date_accepted_jesus" class="mt-2" />
            </div>
            <div class="col-span-6 sm:col-span-4">
                <x-label for="leader" value="{{ __('É lider') }}" />
                <select
                    id="leader"
                    wire:model.defer="form.leader"
                    class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm"
                >
                    <option value="">Selecione</option>
                    <option value="sim">Sim</option>
            ...
            <div class="col-span-6 sm:col-span-4">
                ...
                <select
                    id="Schooling"
                    wire:model.defer="form.Schooling"
                    class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm"
                >
                    <option value="">Selecione</option>
                ...
                <x-input-error for="Schooling" class="mt-2" />
            </div>
            <div class="col-span-6 sm:col-span-4">
