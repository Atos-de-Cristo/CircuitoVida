<div>
    <form>
        <div class="grid gap-2 mb-6 md:grid-cols-5">
            ...
            <div class="col-span-2">
                <input wire:model="attachment" id="{{$rand}}" class="block w-full mb-5 text-xs text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" id="small_size" type="file">
                @error('attachment')
                <span class="text-red-500">{{ $message }}</span>
                @enderror
            </div>
