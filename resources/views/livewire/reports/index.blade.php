<div class="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800">
            ...
            <div class="flex items-center mb-4 md:mb-0">
                ...
                <div>
                    ...
                    <p class="text-slate-600 dark:text-slate-400 mt-1">
                        Análise completa dos eventos e participações
                    </p>
                </div>
            </div>
            <div class="hidden md:inline">
                <nav class="flex items-center space-x-2 text-sm">
                    <a href="{{ route('dashboard') }}" class="text-indigo-500 hover:text-indigo-600 dark:text-indigo-400 dark:hover:text-indigo-300 hover:underline transition-colors">
                        Home
                    </a>
                    <svg class="w-4 h-4 text-slate-400" fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path>
                    </svg>
                    <span class="text-slate-700 dark:text-slate-300 font-medium">Relatórios</span>
                </nav>
            </div>
        </div>

    <!-- Card de Filtros -->
    <div class="bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 dark:border-slate-700/50 mb-8">
        <div class="px-8 py-6 border-b border-slate-200/50 dark:border-slate-700/50">
            <div class="flex items-center">
                ...
                <h4 class="text-xl font-semibold text-slate-800 dark:text-slate-200">Filtros do Relatório</h4>
            </div>
        </div>
                ...
                <div class="flex items-end">
                    <div class="space-y-4 w-full">
                        <button wire:click="generatePreview" 
                            ...
                            <span wire:loading.remove wire:target="generatePreview" class="flex items-center justify-center">
    ...
    @if (!$reportData)
        <div class="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 border border-blue-200/50 dark:border-blue-800/50 rounded-2xl p-8 text-center shadow-lg mb-8">
            ...
            <p class="text-blue-700 dark:text-blue-300">Selecione o período desejado e clique em "Gerar Preview" para visualizar os dados do relatório.</p>
        </div>
    @endif
    ...
    @if ($reportData && (is_array($reportData['detalhe_por_curso']) ? count($reportData['detalhe_por_curso']) : $reportData['detalhe_por_curso']->count()) == 0)
        <div class="bg-gradient-to-r from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20 border border-amber-200/50 dark:border-amber-800/50 rounded-2xl p-8 text-center shadow-lg">
            ...
            <p class="text-amber-700 dark:text-amber-300">Não foram encontrados eventos para o período selecionado. Tente ajustar as datas de filtro.</p>
        </div>
    @endif

    <!-- JavaScript para download do PDF -->
    <script>
