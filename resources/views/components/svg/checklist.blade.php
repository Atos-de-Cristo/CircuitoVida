...
<svg {{ $attributes->merge(['class' => $size]) }} viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg"
    ...
    <g id="SVGRepo_iconCarrier">
        ...
        <g id="Shopicon">
            <polygon {{ $attributes->merge(['class' => $color]) }} points="8,10 26,10 26,6 4,6 4,42 30,42 30,38 8,38 " />
            ...
            <polygon {{ $attributes->merge(['class' => $color]) }}
