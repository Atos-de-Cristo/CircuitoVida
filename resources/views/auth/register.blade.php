                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form class="space-y-4 md:space-y-6" method="POST" action="{{ route('register') }}">
                        ...
                        <div>
                            ...
                            @if ($errors->has('name'))
                                <p id="email-error" class="text-red-600" for="email">{{ $errors->first('name') }}</p>
                            @endif
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            @if ($errors->has('password'))
                              <p id="email-error" class="text-red-600" for="email">{{ $errors->first('password') }}</p>
                            @endif
                        </div>
                        <div>
                            <label for="password_confirmation" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Confirme Senha</label>
                            ...
                            @if ($errors->has('password_confirmation'))
                              <p id="email-error" class="text-red-600" for="email">{{ $errors->first('password_confirmation') }}</p>
                            @endif
                        </div>
